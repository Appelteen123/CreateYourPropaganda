<?php
$pageTitle = 'Create Your Own Propaganda';
...
<div class="create-page">
    ...
    <div id="rulesPanel" class="rules-panel" role="region" aria-label="Spelregels">
        <h2>Spelregels</h2>
        <ul>
            <li>Bedenk iets waar je voor staat.</li>
            <li>Voeg stickers en tekst toe aan je poster.</li>
            <li>Gebruik de tools om te draaien, spiegel en formaten aan te passen.</li>
            <li>Probeer je poster serieus te maken.</li>
            <li>Download je poster met de knop “Download als PNG” en post hem op de website.</li>
        </ul>
    </div>
    ...
    <div class="editor">
        ...
        <div class="canvas-container">
            <div id="canvas" data-download-name="propaganda-poster.png"></div>
        </div>
    </div>
</div>
